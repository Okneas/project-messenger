...
export const RegistrationPage = () => {
  ...
  const handleChangePhoneText = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    let num = `${val.substring(0, 1)}${val.substring(1, 2)} ${val.substring(
      2,
      5
    )} ${val.substring(5, 8)} ${val.substring(8, 10)} ${val.substring(10, 12)}`;
    num = num.trim();
    ...
    case 0:
      return (
        <RegistrationWrapper flexDirection="column" wrap="nowrap" container>
          ...
          ></Box>
          <Typography mt={5} align="center" variant="Heading2">
            Общайтесь легко с <br /> Вашей семьёй и друзьями <br /> в любой
            стране
          </Typography>
          <Typography mt={20} mb={1} align="center" variant="BodyText1">
    ...
    case 1:
      return (
        <RegistrationWrapper flexDirection="column" wrap="nowrap" container>
          ...
          <Typography mt={10} align="center" variant="Heading2">
            Введите Ваш номер <br /> телефона
          </Typography>
          <Typography mt={3} mb={4} align="center" variant="BodyText2">
            Пожалуйста укажите код Вашей страны <br /> и введите номер телефона
          </Typography>
          <PhoneNumberTextBox
            error={invalidPhone}
            placeholder="Номер телефона"
            onChange={handleChangePhoneText}
          ></PhoneNumberTextBox>
          <RegistrationButton
    ...
    case 2:
      return (
        <RegistrationWrapper flexDirection="column" wrap="nowrap" container>
          ...
          <Typography mt={3} mb={4} align="center" variant="BodyText2">
            Мы отправили СМС-код на номер <br /> {phone}
          </Typography>
      ...
      return (
        <RegistrationWrapper flexDirection="column" wrap="nowrap" container>
          <Grid2 container mr="auto">
            ...
            <Typography mt="12px" variant="SubHeading1">
              Ваш профиль
            </Typography>
          </Grid2>
          <Box
