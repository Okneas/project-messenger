    ...
    <MorePageWrapper>
      ...
      <Box sx={{ display: "flex", flexDirection: "column", mt: 2 }}>
        <Container sx={{ mt: 1 }}>
          ...
          >
            <Box sx={{ height: "48px", display: "flex", flexDirection: "row" }}>
              <ProfileIconMore></ProfileIconMore>
              <Typography
                sx={{ pl: "5px" }}
                variant="BodyText1"
                fontSize="14px"
        ...
        <Container sx={{ mt: 1 }}>
          ...
          >
            <Box sx={{ height: "48px", display: "flex", flexDirection: "row" }}>
              <AppearenceIconMore></AppearenceIconMore>
              <Typography
                sx={{ pl: "5px" }}
                variant="BodyText1"
                fontSize="14px"
          ...
          >
            <Box sx={{ display: "flex", flexDisplay: "row" }}>
              <NotificationIconMore></NotificationIconMore>
              <Typography
                sx={{ pl: "5px" }}
                variant="BodyText1"
                fontSize="14px"
          ...
          >
            <Box sx={{ height: "48px", display: "flex", flexDirection: "row" }}>
              <PrivacyIconMore></PrivacyIconMore>
              <Typography
                sx={{ pl: "5px" }}
                variant="BodyText1"
                fontSize="14px"
          ...
          >
            <Box sx={{ height: "48px", display: "flex", flexDirection: "row" }}>
              <DataUsageIconMore></DataUsageIconMore>
              <Typography
                sx={{ pl: "5px" }}
                variant="BodyText1"
                fontSize="14px"
      ...
      <Container sx={{ mt: 1 }}>
        ...
        >
          <Box sx={{ display: "flex", flexDirection: "row" }}>
            <HelpIconMore></HelpIconMore>
            <Typography sx={{ pl: "5px" }} variant="BodyText1" fontSize="14px">
              Помощь
            </Typography>
          </Box>
          <ArrowIcon></ArrowIcon>
        ...
        >
          <Box sx={{ display: "flex", flexDirection: "row" }}>
            <InvitationIconMore></InvitationIconMore>
            <Typography sx={{ pl: "5px" }} variant="BodyText1" fontSize="14px">
              Пригласить друзей
            </Typography>
          </Box>
